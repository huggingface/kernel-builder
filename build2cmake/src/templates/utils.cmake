...
# torch<VERSION>-<ABI>-<COMPUTE>-<SYSTEM> (or torch<VERSION>-<COMPUTE>-<SYSTEM> for aarch64-darwin)
#
# Arguments:
...
#   SYSTEM - System identifier (e.g., "x86_64-linux", "aarch64-darwin")
#
# Example output: torch271-cxx11-cu124-x86_64-linux
#
function(generate_build_name OUT_BUILD_NAME TORCH_VERSION CXX11_ABI COMPUTE_FRAMEWORK COMPUTE_VERSION SYSTEM)
  ...
  # Determine ABI string (skip for aarch64-darwin)
  if(SYSTEM STREQUAL "aarch64-darwin")
    set(ABI_STRING "")
  else()
    if(CXX11_ABI)
      set(ABI_STRING "cxx11")
    else()
      set(ABI_STRING "cxx98")
    endif()
  endif()
  ...
  if(ABI_STRING STREQUAL "")
    set(BUILD_NAME "torch${FLATTENED_TORCH}-${COMPUTE_STRING}-${SYSTEM}")
  else()
    set(BUILD_NAME "torch${FLATTENED_TORCH}-${ABI_STRING}-${COMPUTE_STRING}-${SYSTEM}")
  endif()
